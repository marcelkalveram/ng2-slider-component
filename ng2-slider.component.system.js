...
var Ng2SliderComponent = (function () {
    ...
    Ng2SliderComponent.prototype.valueChangedTrigger = function () {
        //this.valeChangedEvent.emit({start: this.startValue, end: this.endValue});
    ...
    __decorate([
        core_1.Output('onValueChanged'),
        __metadata('design:type', Object)
    ], Ng2SliderComponent.prototype, "valueChangedEvent", void 0);
    __decorate([
